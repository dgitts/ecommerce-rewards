...
//        dd(intval($cart->grand_total));
    ...
    */
    ...
    {
        $cart = Cart::getCart();
        $customerPoints = auth()->guard('customer')->user()->reputation;
        $customerPointsAfterCheckout = $customerPoints - intval($cart->grand_total);
        if ($customerPointsAfterCheckout < 0) {
            $customerPointsAfterCheckout = 'N/A';
        }

        return response()->json([
            'html' => view('shop::checkout.total.summary', compact('cart', 'customerPoints', 'customerPointsAfterCheckout'))->render(),
        ]);
    }
...
//        $data['billing']['address1'] = implode(PHP_EOL, array_filter($data['billing']['address1']));
        ...
        $data['billing']['address1'] = $data['shipping']['address1'];
...
//        }
    ...
    */
    ...
    {
        $cart = Cart::getCart();
//dump($cart->haveStockableItems());
//dd($cart->shipping_address);
