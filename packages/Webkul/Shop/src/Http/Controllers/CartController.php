...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        $customerPointsAfterCheckout = $customerPoints = auth()->guard('customer')->user()->reputation;
        if ($cart) {
            $customerPointsAfterCheckout = $customerPoints - intval($cart->grand_total);
            $customerPointsAfterCheckout = $customerPoints - core()->currency($cart->grand_total);
        }
        ...
        return view($this->_config['view'])->with([
            ...
            'customerPointsAfterCheckout' => $customerPointsAfterCheckout,
        ]);
    }
