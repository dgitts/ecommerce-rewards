<div class="order-summary">
    ...
    <div class="payable-amount" id="customer-points-detail">
        <label>{{ __('Current Points') }}</label>
        <label class="right" id="grand-total-amount-detail">
            {{ __($customerPoints) }}
        </label>
    </div>

    <div class="payable-amount" id="customer-points-after">
        <label>{{ __('Points After Checkout') }}</label>
        <label class="right" id="grand-total-amount-detail">
            {{ __($customerPointsAfterCheckout) }}
        </label>
    </div>
