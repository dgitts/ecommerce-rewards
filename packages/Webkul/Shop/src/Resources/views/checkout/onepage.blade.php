    ...
    <script type="text/x-template" id="checkout-template">
        <div id="checkout" class="checkout-process">
            <div class="col-main">
                ...
                <div class="step-content review" v-show="current_step == 2" id="summary-section">
                    <review-section v-if="current_step == 2" :key="reviewComponentKey">
            ...
            <div class="col-right" v-show="current_step != 2">
                <summary-section :key="summeryComponentKey"></summary-section>
            </div>
        </div>
    </script>
    ...
    <script>
        ...
        @auth('customer')
            @if(auth('customer')->user()->addresses)
                ...
                customerAddress.phone = "{{ auth('customer')->user()->phone }}";
            @endif
        @endauth
        ...
        Vue.component('checkout', {
            ...
            created: function() {
                ...
                if(! customerAddress) {
                    ...
                    this.address.billing.phone = this.address.shipping.phone = customerAddress.phone;
                    this.address.shipping.country = this.address.shipping.country = 'US';
