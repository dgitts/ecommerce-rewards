...
//            dd($data);
            ...
            // Deduct points
            $grandTotal = intval($data['grand_total']);
            PointModification::create([
                'employee_id'  => $data['customer']->employee_id,
                'add'          => 0,
                'points'       => $grandTotal,
                'notes'        => 'Order # ' . $order->id,
            ]);
            $data['customer']->reducePoint($grandTotal);
...
//            $order->payment()->create($data['payment']);
    ...
    {
        $totalQtyOrdered = $totalQtyShipped = $totalQtyRefunded = $totalQtyCanceled = 0;
